...
//
// Cache version bumped to v3 because the shell moved from a single
// /app.js to a modular /scripts/*.js structure (see the redesign) — the
// old v2 cache holds stale/incomplete assets and must be evicted, not
// reused.
